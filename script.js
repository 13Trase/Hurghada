document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateExcursionCards(langData) {
        const excursions = {
            ...
            cairo: document.querySelector('.excursion_card[data-category="historical"]:nth-child(2)'),
            luxor: document.querySelector('.excursion_card[data-category="historical"]:nth-child(3)'),
            parasailing: document.querySelector('.excursion_card[data-category="sea"]:nth-child(4)'),
            quadSafari: document.querySelector('.excursion_card[data-category="safari"]:nth-child(5)'),
            bathyscaphe: document.querySelector('.excursion_card[data-category="sea"]:nth-child(6)')
        };
